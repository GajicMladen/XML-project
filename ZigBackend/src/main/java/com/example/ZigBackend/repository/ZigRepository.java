...
public class ZigRepository {
    ...
    public RemoteXMLResource getZahtevXMLResource(String brojPrijave){
        return ZigDB.getZahtevXMLResource(brojPrijave);
    ...
    private List<ZahtevZaPriznanjeZiga> getAllByStatus(EStatusResenja status) throws JAXBException, XMLDBException {
    ...
    public List<ZahtevZaPriznanjeZiga> getByMetadata(MetadataSearchParams param) throws IOException {
        List<String> ids = FusekiDB.findByMetadata(param);
    ...
    public List<ZahtevZaPriznanjeZiga> getByMultipleMetadata(List<MetadataSearchParams> params) throws IOException {
        List<String> ids = FusekiDB.findByMultipleMetadata(params);
        List<ZahtevZaPriznanjeZiga> zahtevi = getZahteviByBrojPrijave(ids);
    ...
    public String generateRDF(String brojPrijave) throws Exception {
        return FusekiDB.getRdfString(brojPrijave);
    }
